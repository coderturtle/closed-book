...
- [ ] Coachgremlin: author Module 05 (Context and Reliability at Scale), continuing `resolve` — both tiers together, doubt-driven-development before done. `check_module_04` is ready to chain.
