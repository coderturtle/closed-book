...
def run_support_session(
    ...
    for _ in range(max_iterations):
        ...
        # Treat any response whose text sounds like a wrap-up as the end of
        # the turn, not just stop_reason == "end_turn".
        if stop_reason == "end_turn" or "done" in text.lower() or "finished" in text.lower():
