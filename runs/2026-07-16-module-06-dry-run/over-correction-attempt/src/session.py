...
def run_full_support_session(
    ...
    # OVER-CORRECTION: removed the extraction step entirely instead of just
    # removing its misuse as an escalation signal -- Module 02's part of
    # this integration no longer runs at all.
    ...
    for i in range(max_iterations):
        ...
        if rejection is not None:
            ...
            if escalation_reason is not None:
                return {"escalated": True, "reason": escalation_reason, "facts": facts}
            continue
