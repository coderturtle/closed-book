...
FEW_SHOT_EXAMPLES: List[dict] = [
    {
        # Clean, textbook: explicit category cue ("broken"), explicit dollar amount.
    ...
    {
        # Also clean: explicit category cue ("late"), explicit dollar amount.
        # Deliberately not ambiguous -- neither example here requires the model
        # to infer a category from context or handle a missing amount, the
        # exact gap this attempt's dry-run entry exists to represent.
        "message": "My order is two weeks late, refund the $30 shipping I paid.",
        "expected": {
