...
from src.doc_qa import Answer, AnswerFailed, DocIndex, DocQAModelClient, answer_question, retrieve  # noqa: F401
...
def answer_question_with_governance(
    ...
    """
    raise NotImplementedError("Module 09's exercise: implement the governance gate.")
...
def approve_and_release(
    ...
    """
    raise NotImplementedError("Module 09's exercise: implement the approval-release path.")
