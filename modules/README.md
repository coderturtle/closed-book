...
> **Content status: all 10 modules are real. The workshop's full content arc is complete.** [Module 01](01-configuring-claude-code/README.md), [Module 02](02-prompts-structured-output/README.md), [Module 03](03-tool-mcp-design/README.md), [Module 04](04-agentic-orchestration/README.md), [Module 05](05-context-reliability/README.md), and [Module 06](06-foundations-capstone/README.md) each have a working exercise, a real deterministic checker (`scripts/verify_module_01.py` through `verify_module_06.py`, each chaining the one before it per the cumulative-gate convention), a real closed-book checkpoint, and a completed multi-attempt dry run. Module 06 closes Part 1 (Architect Foundations) in full. [Module 07](07-solution-design-context-strategy/README.md) opens Part 2 (Architect Professional) on a new shared project, `fixtures/foundry/` (not a continuation of `resolve` — see [`fixtures/foundry/SPEC.md`](../fixtures/foundry/SPEC.md) for why). [Module 08](08-integration-evaluation/README.md) continues Foundry with the Platform Docs team's RAG documentation Q&A problem. [Module 09](09-governance-stakeholders/README.md) governs and ships Module 08's own system responsibly — a human-in-the-loop gate, a shipping-readiness review, and real team tooling configuration. [Module 10](10-professional-capstone/README.md) closes Part 2 (and the workshop) in full: a written defense of Foundry's own three-system architecture against a real seeded stakeholder objection, plus a full-scale 42-question mock exam across all 7 CCAR-P domains (`scripts/verify_module_10.py`, chaining `check_module_09`). Every module 01-10 has its own real exercise, deterministic checker, closed-book checkpoint, and completed multi-attempt dry run.
